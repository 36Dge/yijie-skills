---
title: Closing Techniques & Timing
impact: MEDIUM-HIGH
tags: closing, commitment, timing, deal, signature
---
...
| Involving finance/procurement | Moving to purchase process |
| Asking for references (again) | Final validation |
| Discussing contract details | Assuming the sale |
...
| Signal | What It Means |
|--------|--------------|
| Going quiet | Concern they haven't raised |
| "We'll discuss internally" | No clear next step |
| Asking same questions repeatedly | Not convinced |
| Fewer stakeholders in meetings | Losing momentum |
| "We're not ready yet" | Undefined blockers |
| Ghosting your champion | Decision made (not in your favor) |
...
|---------|-----------|--------|
| Champion goes quiet | Internal politics or priority shift | Reach out directly, offer to help |
| "We need more time" | Undefined concern | "What would help you feel ready?" |
| New stakeholders appear | Expanding buying center | Embrace, don't resist |
| Repeated delays | Not a priority | Qualify harder, consider walking |
| Price concerns resurface | Value not established | Return to business case |
...
|--------|---------------|
| Send contract immediately | Momentum is perishable |
| Confirm receipt | Ensure right hands |
| Offer to walk through | Remove friction |
| Align on timeline | Set expectations |
| Introduce implementation | Build confidence |
| Thank the champion | They took a risk on you |
