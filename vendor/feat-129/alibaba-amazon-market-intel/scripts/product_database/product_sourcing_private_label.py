"""Product Sourcing & Private Label — Filter lightweight, small-dimension products with healthy sales for private label opportunities."""
...
def analyze(mcp_data, output_dir=None):
    ...
    csv_path = os.path.join(data_dir, 'sourcing_candidates.csv')
